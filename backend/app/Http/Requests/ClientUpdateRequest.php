...
class ClientUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nama_client' => 'sometimes|required|string|max:255',
            'notelp' => 'nullable|string|min:10|max:15|regex:/^[0-9]+$/',
            'email' => [
                'nullable',
                'email',
                'max:255',
                Rule::unique('management_clients', 'email')->ignore($this->client->id), // Pastikan email bisa tetap sama jika tidak diubah
            ],
    ...
    public function messages()
    {
        return [
            ...
            'email.unique' => 'Email sudah digunakan oleh client lain.',
